...
from basis_trade_agent.tools import (
    GetConfigTool,
    GetCurrentPositionTool,
    GetMarketRateTool,
    GetRecentActivityTool,
    GetWalletHoldingsTool,
    UpdateConfigTool,
)
...
def main() -> None:
    ...
    tools = [GetConfigTool(), UpdateConfigTool(), GetWalletHoldingsTool(), GetCurrentPositionTool(), GetRecentActivityTool(), GetMarketRateTool()]
